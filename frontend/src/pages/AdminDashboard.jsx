        ...
        <div className="container mx-auto p-6">
          ...
          >
            ...
            <motion.button
              ...
              className="mt-4 md:mt-0 px-6 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg shadow-md"
          ...
          >
            ...
            {[
              ...
              { title: "Active", value: hospitals.filter(h => h.status === 'Active').length, color: "from-green-500 to-teal-500" },

              { title: "Inactive", value: hospitals.filter(h => h.status === 'Inactive').length, color: "from-red-500 to-pink-500" },

              { title: "Pending", value: hospitals.filter(h => h.status === 'Pending').length, color: "from-yellow-500 to-amber-500" }
